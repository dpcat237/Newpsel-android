...
public class GrabDictationService implements TextToSpeech.OnInitListener {
    ...
    private volatile static GrabDictationService uniqueInstance;
    ...
    private GrabDictationService(Context context) {
        mContext = context;
    }

    public static GrabDictationService getInstance(Context context) {
        if (uniqueInstance == null) {
            synchronized (GrabDictationService.class) {
                if (uniqueInstance == null) {
                    uniqueInstance = new GrabDictationService(context);
                }
            }
        }
    ...
    {
        final GrabDictationService callWithResult = this;
